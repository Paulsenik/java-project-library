...
public class PUIText extends PUIElement {
  ...
  public static final String[] selectableFonts = {"Consolas", "Courier New", "Lucida Console",
      "MingLiU-ExtB",
  ...
  /**
   * Sets an installed <b>Monospace-Font</b> as the font that is displayed if the PUIText is
   * <b>selectable</b>
   *
   * @param selectFont Should be a Monospace-Font!!! Due to pixel-alignment with the selected Area
