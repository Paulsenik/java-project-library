...
public class PConsole {
   ...
   * @return the response of the console.<br>The Error-Stream will be put at the end with "ERROR>  "
   * at the beginning of every line.
   * @apiNote <b>This is a BLOCKING-Method</b>. The Method might never return anything if one
   ...
   * Runs a given Command in the Terminal/Console (Linux/Windows) and returns the response
   *
   * @param workingDir Folder in which the command should be executed in.<br>If Null or path doesn't
   *                   point to a Folder: The workingDir will be ignored.
   * @param command    Command that is executed (Do <b>NOT</b> use sudo on Linux with this
   *                   function)
   * @return the response of the console.<br>The Error-Stream will be put at the end with "ERROR>  "
   * at the beginning of every line.
   * @apiNote <b>This is a BLOCKING-Method</b>. The Method might never return anything if one
