...
import de.paulsenik.jpl.ui.PUIElement.ElementAlignment;
import de.paulsenik.jpl.ui.PUIList;
import de.paulsenik.jpl.ui.PUIMatrix;
import de.paulsenik.jpl.ui.PUIRotaryControl;
import de.paulsenik.jpl.ui.PUISlider;
...
public class Demo {
  ...
  public Demo() {
    ...
    try {
      ...
      JOptionPane.showMessageDialog(null, "Port 8123 already taken by another Process",
          "Instance already running", JOptionPane.INFORMATION_MESSAGE);
      System.exit(0);
    }

    frameTitle =
        "JPL-Demo - " + PSystem.getUserName() + "'s " + PSystem.getOSType() + "-System from "
            + PSystem.getUserDisplayLocation();
